...
for rollback_method in ['rollback-none', 'rollback-stochastic', 'rollback-deterministic']:
    file_path = f'./data/Ndata.merged.anonymized.single.relabeled.{rollback_method}.p'
    ...
    for start_date in dates[::-1]:
        ...
        file_name = f'./data/processed_data_{start_date}_{rollback_method}.pickle'
