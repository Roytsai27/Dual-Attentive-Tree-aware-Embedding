...
if __name__ == '__main__':
    ...
    # load torch dataset 
    data_path = f'./data/torch_data_{starting_date}_{ntree}_{ndepth}.pickle'
    print(data_path)
    ...
    model_path = f'./saved_models/DATE_{starting_date}_{dim}_{head_num}_{exp_id}.pkl'
    ...
    model_name = f'DATE_{starting_date}_{dim}_{head_num}'
    ...
    if os.path.isfile(output_file):
        ...
        with open(output_file, 'a') as ff:
             ...
             # Write on file
            print(f'{starting_date},{overall_f1},{auc},{precisions[0]},{precisions[1]},{precisions[2]},{precisions[3]},{recalls[0]},{recalls[1]},{recalls[2]},{recalls[3]},{revenues[0]},{revenues[1]},{revenues[2]},{revenues[3]},{model_name},{epochs},{dim},{lr},{weight_decay},{beta},{head_num},{fusion},{act},{ntree},{ndepth}', file=ff)
        ...
        with open(output_file, 'a') as ff:
            ...
            # Write on file
            print("starting_date,f1,auc,pr1,pr2,pr5,pr10,re1,re2,re5,re10,rev1,rev2,rev5,rev10,model,epoch,dim,lr,l2,beta,heads,fusion,activation,ntree,ndepth", file=ff)
            print(f'{starting_date},{overall_f1},{auc},{precisions[0]},{precisions[1]},{precisions[2]},{precisions[3]},{recalls[0]},{recalls[1]},{recalls[2]},{recalls[3]},{revenues[0]},{revenues[1]},{revenues[2]},{revenues[3]},{model_name},{epochs},{dim},{lr},{weight_decay},{beta},{head_num},{fusion},{act},{ntree},{ndepth}', file=ff)
