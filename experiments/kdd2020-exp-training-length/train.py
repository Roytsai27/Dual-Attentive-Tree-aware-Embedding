...
if __name__ == '__main__':
    ...
    parser.add_argument('--output',
                        type=str,
                        default="training-length-l2-001-new.csv",
    ...
    if os.path.isfile(output_file):
        ...
        with open(output_file, 'a') as ff:
             ...
             # Write on file
            print(f'{starting_date},{overall_f1},{auc},{precisions[0]},{precisions[1]},{precisions[2]},{precisions[3]},{recalls[0]},{recalls[1]},{recalls[2]},{recalls[3]},{revenues[0]},{revenues[1]},{revenues[2]},{revenues[3]},{model_name},{epochs},{dim},{lr},{weight_decay},{beta},{head_num},{fusion},{act},{exp_id}', file=ff)
        ...
        with open(output_file, 'a') as ff:
            ...
            # Write on file
            print("starting_date,f1,auc,pr1,pr2,pr5,pr10,re1,re2,re5,re10,rev1,rev2,rev5,rev10,model,epoch,dim,lr,l2,beta,heads,fusion,activation,exp_id", file=ff)
            print(f'{starting_date},{overall_f1},{auc},{precisions[0]},{precisions[1]},{precisions[2]},{precisions[3]},{recalls[0]},{recalls[1]},{recalls[2]},{recalls[3]},{revenues[0]},{revenues[1]},{revenues[2]},{revenues[3]},{model_name},{epochs},{dim},{lr},{weight_decay},{beta},{head_num},{fusion},{act},{exp_id}', file=ff)
